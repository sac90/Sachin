<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="studentsignup.aspx.cs" Inherits="student_studentsignup" %>
...
<form id="form1">
    <div align="center" style="height: 469px"> 
      <div 
            ...
            style="height: 44px; width: 709px; font-size: xx-large; font-weight: bold; color: #FFFFCC; background-color: 

#003366; text-decoration: underline blink;" 
            align="center">
          SIGNUP</div>
        <div 
        ...
        <div 
           ...
           >
                  &nbsp;
                  <asp:DropDownList ID="gen" runat="server" AutoPostBack="True" 
            ...
            style="width: 283px; font-size: large; font-weight: bold; color: #003366;">
                  &nbsp; 
                  <asp:TextBox ID="uid" 
                      runat="server" Width="197px"></asp:TextBox>
        </div><div 
           ...
           >
            ...
            align="center" >
                      ...
                      <asp:Label ID="mess" runat="server" BackColor="Red" BorderStyle="Solid" 
                          ...
                          Text="password do not match" Visible="False"></asp:Label>
                      <br />
                      Click here for
                      <asp:HyperLink ID="HyperLink10" runat="server" NavigateUrl="studentlogin.aspx">LOGIN</asp:HyperLink>
        </div>
        </div>
           </form>
</div>
